...
namespace KzBBS
{
    ...
    public sealed partial class Home : Page
    {
        ...
        private async void DetermineCanvasSize()
        {
            ...
            if (winSize.Width > winSize.Height) //Landscape
            {
                ...
                telnetFontSize = 15 * factor;
                PTTDisplay._fontSize = 15 * factor;
                clipB.FontSize = 15 * factor;
                clipB.LineHeight = 15 * factor;
                ...
                Canvas.SetLeft(hotkeyPanel, PTTCanvas.Width - 5);
            ...
            {
                //Show the status bar
                await topStatusBar.ShowAsync();
                Canvas.SetTop(buttonsPanel, appCanvas.Height - buttonsPanel.DesiredSize.Height - 40);

                PTTDisplay.isPortrait = true;
                factor = winSize.Height / 600;
                telnetFontSize = 12.5 * factor;
                PTTDisplay._fontSize = 12.5 * factor;
                clipB.FontSize = 12.5 * factor;
                clipB.LineHeight = 12.5 * factor;
        ...
        private void Select_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                //string test = "直播連結http://ppt.cc/%E7%20%20tlhD連結 21:00 Ptt鄉民\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"
                //+ "直播連結: http://ppt.cc/tlhD 21:00 https://xxx.ggg.cc/連結.xx.dd ssdfsdfsdfsdfsd";
